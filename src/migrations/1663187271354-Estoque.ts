...
export class Estoque1663187271354 implements MigrationInterface {
    name = 'Estoque1663187271354'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "accessLog" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accessDate" date NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_2c29a0c4a68e599e9f476938bdd" PRIMARY KEY ("id"))`);
