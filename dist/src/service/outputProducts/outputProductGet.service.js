...
const outputProductGetService = () => __awaiter(void 0, void 0, void 0, function* () {
    const outputProductRepository = data_source_1.default.getRepository(outputProduct_entitys_1.OutputProduct);
    const outputProduct = yield outputProductRepository.find();
    return outputProduct;
});
exports.default = outputProductGetService;
